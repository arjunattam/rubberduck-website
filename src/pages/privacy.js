  ...
  <MiniSection
    content={
      <div style={{ margin: 50 }}>
        ...
        <p>Effective date: October 01, 2018</p>

        <p>
          Karigari Labs LLP ("us", "we", or "our") operates the Rubberduck
        ...
        <p>Karigari Labs LLP uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Karigari Labs LLP will take all steps reasonably necessary to ensure
        ...
        <p>
          Karigari Labs LLP may disclose your Personal Data in the good faith
          belief that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>
            To protect and defend the rights or property of Karigari Labs LLP
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              For more information on what type of information Amplitude
              collects, please visit the Terms of Use page of Amplitude:{' '}
              <a href="https://amplitude.com/terms">
        ...
        <ul>
          <li>By email: team@karigari.io</li>
        </ul>
      </div>
    }
  />
